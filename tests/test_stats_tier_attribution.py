    ...
    timelines = _timelines(
        [
            (
                sub,
                [
                    FakeEvent("created", datetime(2026, 6, 1), {"tier": "plus"}),
...
def test_upgrade_splits_credits_across_go_and_plus():
    ...
    timelines = _timelines(
        [
            (
                go_sub,
                [
                    FakeEvent("created", datetime(2026, 6, 1), {"tier": "go"}),
            ...
            (
                plus_sub,
                [
                    FakeEvent("created", datetime(2026, 6, 3), {"tier": "plus"}),
    ...
    totals = StatsService._aggregate_credits_by_tier(credits, timelines, date(2026, 6, 1), date(2026, 6, 4))

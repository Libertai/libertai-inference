...
class _Config:
    ...
    FREE_CHAT_RATE_LIMIT_PER_MINUTE: int
    FREE_CHAT_RATE_LIMIT_PER_DAY: int
    ...
    def __init__(self):
        ...
        self.FREE_CHAT_RATE_LIMIT_PER_MINUTE = int(os.getenv("FREE_CHAT_RATE_LIMIT_PER_MINUTE", "20"))
        self.FREE_CHAT_RATE_LIMIT_PER_DAY = int(os.getenv("FREE_CHAT_RATE_LIMIT_PER_DAY", "300"))
